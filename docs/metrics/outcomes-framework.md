...
Defines **future** metrics for BIU.G Academy. No production analytics dashboard exists today. Collection begins when cohorts operate and privacy policies are finalized.

**Status:** Framework **under development**; measurement **planned**.
...
- Metrics design reviewed against [../regulatory/data-privacy-position.md](../regulatory/data-privacy-position.md)
- No public reporting that re-identifies individuals
- Methodology notes published with outcomes reports
