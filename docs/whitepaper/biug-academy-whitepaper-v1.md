---
title: "BIU.G Academy: Building Human Capital Infrastructure for Angola’s Digital Future"
version: "1.0"
status: "Strategic White Paper"
prepared_by: "Fabio Guilherme Massanga"
roles: "Founder & Executive Director – BIU.G Academy; Founder & CEO – Biu-g Holdings LLC"
website: "https://biugacademy.org"
contact: "support@biugacademy.org"
date: "May 2026"
disclaimer: "This document describes strategic intent. Capabilities marked Future or Under development are not operational unless explicitly stated as Current."
---
...
```mermaid
flowchart LR
  User[Learner / Applicant]
  Browser[Mobile or desktop browser]
  GHP[GitHub Pages static assets]
  Intake[External intake bridge optional]

  User --> Browser
  Browser --> GHP
  Browser -.->|application submit| Intake
```
...
```mermaid
flowchart TB
  subgraph client [Client layer - Future]
    PWA[PWA / mobile web]
    Offline[Offline module cache]
  end
  ...
  subgraph data [Data layer - Future]
    DB[(Database)]
    Analytics[Analytics pipeline]
  end

  subgraph ai [Assistive AI - Future]
    Classify[Reviewer assist classification]
    Coach[Learning coach optional]
  end

  subgraph ops [Operations - Future]
...
```mermaid
timeline
  title BIU.G Academy roadmap (indicative)
  section Current
    Phase 0 Public presence : Active
  section Under development
    Phase 1 Initial cohorts : In preparation
  section Future
    Phase 2 Curriculum : Planned
    Phase 3 Offline systems : Planned
    Phase 4 Data and analytics : Planned
    Phase 5 AI assist : Planned
    Phase 6 Partnerships : Planned
```
