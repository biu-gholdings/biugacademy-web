# Translation glossary (PT / EN / FR)

Preferred institutional terms for multilingual parity. Portuguese (Angola) is the **source of truth** for new public content.
...
## Regulatory phrases (meaning must match)

**PT (reference):**

> A BIU.G Academy não é uma universidade e atualmente não emite graus académicos acreditados.

**EN:**

> BIU.G Academy is not a university and does not currently issue accredited academic degrees.

**FR:**

> BIU.G Academy n’est pas une université et ne délivre actuellement pas de diplômes académiques accrédités.
...
2. Translate EN with this glossary
3. French update when PT/EN stable
4. Maintainer review for regulatory parity

---

## Related

- [../design/content-style-guide.md](../design/content-style-guide.md)
